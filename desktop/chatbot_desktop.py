...
def getAnswer():
    ...
    ChatBox.config(foreground="Black", font=("Verdana", 12))
    ...
    def send(msg):
        try:
            ...
            # res decoded_translation
            res = str(decoded_translation)
...
SendButton = Button(root, bd=0, background="white", fg='#000000', text="Оправить", font="Arial 12", command=getAnswer)
EntryBox = Text(root, bd=0, bg="white", width="29", height="5")

scrollbar.place(x=376, y=6, height=386)
ChatBox.place(x=6, y=6, height=386, width=370)
EntryBox.place(x=6, y=401, height=90, width=300)
SendButton.place(x=312, y=430, height=30, width=80)
root.mainloop()
